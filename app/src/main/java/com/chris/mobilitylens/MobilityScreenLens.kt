...
fun DisplayMobilityLens(innerPadding: PaddingValues) {
    ...
    Column(
        ...
        DisplayDimensions(
            stringResource(R.string.description), stringResource(currDimension.description)
        )
        DisplayDimensions(
            stringResource(R.string.implication), stringResource(currDimension.implication)
        )
        ...
        //onUserTextChange is a function reference so that the code in the function
        //is executed inside the current function, and the state is remembered
        DisplayUserTextField(userText) { userText = it }
        ...
        DisplayReadOnlyTextField(displayText)
    }
}


@Composable
fun DisplayUserTextField(userText: String, onUserTextChange: (String) -> Unit) {
...
@Composable
fun DisplayReadOnlyTextField(displayText: String)
{
    OutlinedTextField(
        value = displayText,
        //we want it to be read only
        onValueChange = {}, label = {}, modifier = Modifier
            .fillMaxWidth()
            .padding(16.dp)
    )
